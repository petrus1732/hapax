  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      <form action={formAction} className="mb-4">
        <div className="mb-4 w-72">{session?.user ? '' : 'Log in to store your board!'}</div>
        ...
        {size && (
          <>
            <div className="mb-4">
              <label className="mb-2 block text-sm font-medium">Enter letters</label>
                ...
                <section key={id} className="p-2">
                  ...
                  <ul className="flex flex-wrap">
                    {ws.map((w, idx) => (
                      <li
                        key={idx}
                        style={{ width: 270.4 / ((270.4 / (id * 15)) | 0) + 'px' }}
                        className="flex-none"
                      >
                        {w}
                      </li>
